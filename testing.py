...
while isRunning:
    ...
    if compareSquares(sq1.x, sq2.x, sq1.y, sq2.y, sq1_width, sq2_width):
    ...
    if compareSquares(sq3.x, sq4.x, sq3.y, sq4.y, sq3_width, sq4_width):
    ...
    if compareSquares(sq5.x, sq6.x, sq5.y, sq6.y, sq5_width, sq6_width):
    ...
    if compareSquares(sq7.x, sq8.x, sq7.y, sq8.y, sq7_width, sq8_width):
    ...
    if compareSquares(sq9.x, sq10.x, sq9.y, sq10.y, sq9_width, sq10_width):
